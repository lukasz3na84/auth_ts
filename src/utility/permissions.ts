// rozbicie tablicy usersRoles na mniejsze kawałki:
...
class Permissions {
  ...
  constructor(usersRoles: Role[]) {
    this.usersRoles = usersRoles;
  }

  addRoleParents(targetRole: UserRole, sourceRole: UserRole) {
    ...
    isResourceAllowedForUser(userRole: UserRole, resource: string, method: string): boolean {
